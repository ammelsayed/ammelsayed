...
def info_lines(s):
    ...
    return [
        ...
        kv("Kernel", "Particle Physicist"),
        kv("IDE", "Cursor, VS Code"),
        [],
        kv("Languages.Programming", "Python, C/C++, Fortran, JavaScript"),
        kv("Languages.Real", "Chinese, Arabic, English"),
        kv("Hobbies", "Tennis, Studying"),
        [],
        rule("Contact"),
        kv("Email", "ammelsayed@ustc.mail.edu.cn"),
        kv("LinkedIn", "in/a-m-m-elsayed/"),
        [],
        rule("GitHub Stats"),
